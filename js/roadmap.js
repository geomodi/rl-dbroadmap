...
function animateTitleText() {
    ...
    const baseSubtitle = document.querySelector('.subtitle-text-base');
    const lightSubtitle = document.querySelector('.subtitle-text-light');
    ...
    function animateTravelingLight() {
        ...
        anime.set([lightTitle, lightSubtitle], {
            opacity: 1
        });
